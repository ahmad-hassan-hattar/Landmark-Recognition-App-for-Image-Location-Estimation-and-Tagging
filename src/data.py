...
def get_data_loaders(
    ...
    # Create data transforms for training, validation, and test sets
    data_transforms = {
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    # Create empty lists to store the batch of images and labels
    images_list = []
    labels_list = []

    # Iterate through the data loader to obtain one batch
    for _ in range(max_n):
        images, labels = next(dataiter)
        images_list.append(images)
        labels_list.append(labels)

    # Concatenate the batch of images and labels into tensors
